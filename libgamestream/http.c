...
#else
static pthread_mutex_t blob_lock = PTHREAD_MUTEX_INITIALIZER;
#define BLOB_LOCK() pthread_mutex_lock(&blob_lock)
#define BLOB_UNLOCK() pthread_mutex_unlock(&blob_lock)
#endif
