...
namespace moonlight_xbox_dx
{
	...
	private:
		...
		void toggleVsync_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
		void toggleFullscreen_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
